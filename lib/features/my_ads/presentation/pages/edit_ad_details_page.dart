    ...
    return BlocConsumer<PropertyAddAdCubit, PropertyAddAdState>(
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          //                 TextFieldWidget(
          //                   initialValue:
          //                       myAdsCubit.myAds[indexForEdit].adTitle,
          //                   paddingVertical: 0,
          ...
          //                       .myAds[indexForEdit].client.phoneNumber,
          //                   paddingVertical: 0,
          ...
          //                 TextFieldWidget(
          //                     initialValue:
          //                       myAdsCubit.myAds[indexForEdit].info.totalArea
          //                           .toString(),
          //                   paddingVertical: 0,
          ...
          //                 TextFieldWidget(
          //                     initialValue:
          //                       myAdsCubit.myAds[indexForEdit].info.netArea
          //                           .toString(),
          //                   paddingVertical: 0,
          //                   onChanged: (value) {
          //                     propertyAddAdCubit.setPropertyField(
          ...
          //                 TextFieldWidget(
          //                     initialValue:
          //                       myAdsCubit.myAds[indexForEdit].description,
          //                   paddingVertical: 8,
          //                   maxLines: 8,
